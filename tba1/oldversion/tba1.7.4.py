...
class scene_type:
    def __init__(self, xpos, ypos, zpos, name, temp, light, safe, npc, passable, treasure, difficulty, biome, impass_msg, flavour, scene_inventory, scene_weapon_inventory, scene_armor_inventory, scene_helmet_inventory, scene_shield_inventory):
        self.xpos = xpos
        self.ypos = ypos
        self.zpos = zpos
        self.name = name
...
hills = scene_type(0,0,0,"the hills","temperate","sunny",True,True,True,False,0,"forest","","rolling green hills",[],[],[],[],[])
lakeside = scene_type(0,-1,0,"lakeside","temperate","sunny",True,False,True,False,0,"forest","","the shore of the lake",[],[],[],[],[])

#large tree cave
large_tree = scene_type(1,0,0,"a large tree","temperate","shady",True,True,True,False,0,"forest","","a very, very large oak tree",[],[],[],[],[])
large_tree_tunnel_a = scene_type(1,0,-1,"a tunnel","temperate","shady",True,False,True,False,0,"forest","","there are tree roots supporting the tunnel",[],[],[],[],[])
large_tree_tunnel_b = scene_type(1,0,-2,"a tunnel ","temperate","shady",True,False,True,False,0,"forest","","the tunnel goes down quite far",[],[],[],[],[])
large_tree_cave_a = scene_type(1,0,-3,"oak tree cave","temperate","shady",True,False,True,False,0,"forest","","a cave below the large oak tree",[],[],[],[],[])
large_tree_cave_b = scene_type(0,0,-3,"oak tree cave","temperate","shady",True,False,True,False,0,"forest","","a cave below the large oak tree",[],[],[],[],[])
large_tree_cave_c = scene_type(0,-1,-3,"oak tree cave","temperate","shady",True,False,True,False,0,"forest","","a cave below the large oak tree",[],[],[],[],[])
large_tree_cave_d = scene_type(0,-2,-3,"oak tree cave","temperate","shady",True,False,True,False,0,"forest","","a cave below the large oak tree",[],[],[],[],[])
large_tree_cave_e = scene_type(0,-3,-3,"oak tree cave","temperate","shady",True,False,True,False,0,"forest","","a cave below the large oak tree",[],[],[],[],[])

large_tree_cave_door = scene_type(0,-4,-3,"oak doorway","temperate","shady",True,False,False,False,0,"forest","this door is locked, you need a key..","The door is unlocked...",[],[],[],[],[])

large_tree_cave_f = scene_type(0,-5,-3,"oak tree cave","temperate","shady",True,False,True,False,0,"forest","","a cave below the large oak tree",[],[],[],[],[])

birds_nest = scene_type(2,0,0,"a bird's nest","cosy","dimly lit",True,True,True,False,0,"forest","","you are in a house made of twigs and branches",[],[],[],[],[])

forest_a = scene_type(3,0,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","it's dark here",[],[],[],[],[])
forest_b = scene_type(3,1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","the smell of pine forest is very strong here",[],[],[],[],[])
forest_c = scene_type(4,0,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","lots of trees...",[],[],[],[],[])
forest_d = scene_type(4,1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","there's a circle of rocks in a small clearing",[],[],[],[],[])
forest_e = scene_type(3,2,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","small mushrooms litter the ground here",[],[],[],[],[])
forest_f = scene_type(2,1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","there is a smoke to the north",[],[],[],[],[])
forest_g = scene_type(4,2,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","",[],[],[],[],[])
forest_h = scene_type(4,-1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","the forest isn't so dense here",[],[],[],[],[])
forest_i = scene_type(3,-1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","",[],[],[],[],[])
forest_j = scene_type(2,-1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","",[],[],[],[],[])
forest_k = scene_type(1,-1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","",[],[],[],[],[])
forest_l = scene_type(1,1,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","",[],[],[],[],[])
forest_m = scene_type(1,2,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","",[],[],[],[],[])
forest_n = scene_type(2,3,0,"the dark forest","cold","shady",False,False,True,False,0,"forest","","",[],[],[],[],[])

forest_cabin = scene_type(2,2,0,"the forest cabin","temperate","cloudy",True,True,True,False,0,"forest","", "a nice log cabin, many strange objects are displayed on shelves and a large desk has piles of books next to it.",[],[],[],[],[])

grassland_a = scene_type(2,5,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])
grassland_b = scene_type(1,5,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])
grassland_c = scene_type(1,4,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])
grassland_d = scene_type(1,3,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])
grassland_e = scene_type(3,5,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])
grassland_f = scene_type(3,4,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])
grassland_g = scene_type(3,3,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])

grassland_h = scene_type(6,-1,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])
grassland_i = scene_type(7,-1,0,"grassland","cold","shady",False,False,True,False,0,"forest","","wide open space, lots of grass",[],[],[],[],[])

crossroads = scene_type(5,0,0,"the crossroads","temperate","sunny",False,False,True,False,0,"forest","","There is a sign pointing north labelled \' Dismurth \' ",[],[],[],[],[])
east_road = scene_type(6,0,0,"the east road","hot","sunny",False,False,True,False,0,"forest","","this narrow road leads from the crossroads to the east",[],[],[],[],[])
north_road = scene_type(5,1,0,"the north road","hot","sunny",False,False,True,False,0,"forest","","this road leads from the crossroads to the northern town of Dismurth, it looks well travelled",[],[],[],[],[])
dismurth_gates = scene_type(5,2,0,"the town gates of Dismurth","hot","sunny",True,True,True,False,0,"town","","",[],[],[],[],[])
dismurth_square = scene_type(5,3,0,"the town square of Dismurth","hot","sunny",True,True,True,False,0,"town","","",[],[],[],[],[])
dismurth_tower = scene_type(5,4,0,"the tower of Dismurth","hot","sunny",True,True,True,False,0,"town","","the tower walls ar elined with bookshelves, there are many large runestones in the middle of the room",[],[],[],[],[])
dismurth_smith = scene_type(6,3,0,"the Blacksmith of Dismurth","hot","sunny",True,True,True,False,0,"forest","","*a young man is working hard at the furnace*",[],[],[],[],[])
dismurth_barracks = scene_type(4,3,0,"the Barracks of Dismurth","warm","dimly liy",True,True,True,False,0,"forest","","you are surrounded by bunks and weapon racks, there is a large table in the middle of the room, a fire crackles in the corner",[],[],[],[],[])
dismurth_farm = scene_type(6,2,0,"the Dismurth farmstead","hot","sunny",True,True,True,False,0,"forest","","",[],[],[],[],[])
turnip_field = scene_type(7,2,0,"a turnip field","hot","sunny",True,True,True,False,0,"forest","","turnips bruzzy",[],[],[],[],[])
moors_a = scene_type(6,1,0,"the moors","humid","sunny",False,False,True,True,0,"forest","","damp grass and low stone walls form paddocks around you",[],[],[],[],[])
moors_b = scene_type(7,1,0,"the moors","humid","sunny",False,False,True,True,0,"forest","","",[],[],[],[],[])

fortress_gate = scene_type(7,0,0,"the bandit fortress gates","humid","sunny",False,False,True,False,0,"forest","","",[],[],[],[],[])
fortress = scene_type(8,0,0,"the bandit fortress","humid","sunny",False,False,True,False,0,"forest",""," surrounded by a palisade wall",[],[],[],[],[])
wall_a = scene_type(8,1,0,"fortress wall","temp_string","light_string",False,False,False,False,0,"forest","the large, wooden wall blocks your path","",[],[],[],[],[])
wall_b = scene_type(8,-1,0,"fortress wall","temp_string","light_string",False,False,False,False,0,"forest","the large, wooden wall blocks your path","",[],[],[],[],[])
wall_c = scene_type(9,0,0,"fortress wall","temp_string","light_string",False,False,False,False,0,"forest","the large, wooden wall blocks your path","",[],[],[],[],[])

highlands = scene_type(10,10,0,"highlands","humid","sunny",False,False,True,False,0,"forest","","",[],[],[],[],[])

plains_a = scene_type(-1,2,0,"plains","humid","sunny",False,False,True,False,0,"forest","","sandy plains",[],[],[],[],[])
plains_b = scene_type(-1,1,0,"plains","humid","sunny",False,False,True,False,0,"forest","","sandy plains",[],[],[],[],[])
crags = scene_type(15,15,0,"crags","temperate","cloudy",False,False,True,False,0,"forest","", "some particularly generic crags, very rocky indeed",[],[],[],[],[])
fields = scene_type(16,16,0,"ordinary fields","temperate","cloudy",False,False,True,False,0,"forest","", "some particularly generic fields",[],[],[],[],[])
swamp = scene_type(17,17,0,"swamp","temperate","cloudy",False,False,True,False,0,"forest","", "some particularly generic fields",[],[],[],[],[])

south_road_a = scene_type(5,-1,0,"the south road","temperate","cloudy",True,True,True,False,0,"road","", "this road leads from the crossroads to the south ",[],[],[],[],[])
dismurth_bridge = scene_type(5,-2,0,"the Dismurth bridge","temperate","cloudy",True,False,True,False,0,"road","you may not cross the bridge without rite of passage", "the river looks nice from here",[],[],[],[],[])
south_road_b = scene_type(5,-3,0,"the south road","temperate","cloudy",True,True,True,False,0,"road","", "this road continues from the crossroads to the south",[],[],[],[],[])

#south east cave
cave_entrance = scene_type(5,-4,0,"a cave entrance","temperate","cloudy",True,False,True,False,0,"forest","", "there is a cave enterance in the ground here, looks like it goes straight down",[],[],[],[],[])
cave_a = scene_type(5,-4,-1,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further...",[],[],[],[],[])
cave_b = scene_type(5,-4,-2,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further...",[],[],[],[],[])
cave_c = scene_type(5,-4,-3,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further...",[],[],[],[],[])
cave_d = scene_type(5,-4,-4,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further...",[],[],[],[],[])
cave_e = scene_type(5,-4,-5,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further...",[],[],[],[],[])
cave_f = scene_type(5,-4,-6,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further...",[],[],[],[],[])
cave_g = scene_type(5,-4,-7,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further...",[],[],[],[],[])
cave_h = scene_type(5,-4,-8,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "there is a cavern below...",[],[],[],[],[])

cavern_a = scene_type(5,-4,-9,"the center of a cavern","temperate","cloudy",True,False,True,False,0,"forest","", "there is light coming from above...",[],[],[],[],[])
cavern_b = scene_type(5,-3,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])
cavern_c = scene_type(5,-5,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])
cavern_d = scene_type(6,-3,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])
cavern_e = scene_type(4,-3,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])
cavern_f = scene_type(4,-4,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])
cavern_g = scene_type(4,-5,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])
cavern_h = scene_type(6,-4,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])
cavern_i = scene_type(6,-5,-9,"a cavern","temperate","cloudy",False,False,True,False,0,"forest","", "",[],[],[],[],[])

#north cave
north_cave_entrance = scene_type(2,4,0,"a cave entrance","temperate","cloudy",True,False,True,False,0,"forest","", "there is a cave enterance in the ground here, looks like it goes straight down",[],[],[],[],[])
north_cave_a = scene_type(2,4,-1,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further, there is light coming from above...",[],[],[],[],[])
north_cave_b = scene_type(2,4,-2,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further, there is light coming from above...",[],[],[],[],[])
north_cave_c = scene_type(2,4,-3,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further, there is a faint light coming from above...",[],[],[],[],[])
north_cave_d = scene_type(2,4,-4,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further, there is a faint light coming from above...",[],[],[],[],[])
north_cave_e = scene_type(2,4,-5,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further, there is a faint light coming from above...",[],[],[],[],[])
north_cave_f = scene_type(2,4,-6,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further, there is a faint light coming from above...",[],[],[],[],[])
north_cave_g = scene_type(2,4,-7,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "this cave goes down further, there is a faint light coming from above...",[],[],[],[],[])
north_cave_h = scene_type(2,4,-8,"a cave","temperate","cloudy",True,False,True,False,0,"forest","", "there is a tunnnel below, there is a very faint light coming from above...",[],[],[],[],[])

tunnel_a = scene_type(2,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "there is a very faint light coming from above...",[],[],[],[],[])
tunnel_b = scene_type(3,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel, i wonder why it's here",[],[],[],[],[])
tunnel_c = scene_type(4,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "there are carvings on the wall, they depict goblins fighting some kind of demonic creature.",[],[],[],[],[])
tunnel_d = scene_type(5,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "there are carvings of goblins and humans massed in a large army, 2",[],[],[],[],[])

tunnel_e = scene_type(5,3,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel, i wonder why it's here",[],[],[],[],[])
tunnel_f = scene_type(5,2,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel, carvings depict a three headed dragon fighting a large demon",[],[],[],[],[])
tunnel_g = scene_type(5,1,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel, skeletons of ancient warriors line the walls here",[],[],[],[],[])
tunnel_h = scene_type(5,0,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel",[],[],[],[],[])
tunnel_i = scene_type(5,-1,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel, it smells of decay",[],[],[],[],[])
tunnel_j = scene_type(5,-2,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel, the air is still",[],[],[],[],[])
tunnel_k = scene_type(5,-3,-9,"an underground tunnel","temperate","cloudy",False,False,True,False,0,"forest","", "this is an ancient tunnel, it's carved from solid rock",[],[],[],[],[])

cliffs_a = scene_type(-1,0,0,"cliffs","temp_string","light_string",False,False,False,False,0,"forest","cliffs block your path","",[],[],[],[],[])
cliffs_b = scene_type(0,1,0,"cliffs","temp_string","light_string",False,False,False,False,0,"forest","cliffs block your path","",[],[],[],[],[])
cliffs_c = scene_type(0,2,0,"cliffs","temp_string","light_string",False,False,False,False,0,"forest","cliffs block your path","",[],[],[],[],[])
cliffs_d = scene_type(-1,-1,0,"cliffs","temp_string","light_string",False,False,False,False,0,"forest","cliffs block your path","",[],[],[],[],[])
river_a = scene_type(1,-2,0,"river","temp_string","light_string",False,False,False,False,0,"forest","a river blocks your path","",[],[],[],[],[])
river_b = scene_type(2,-2,0,"river","temp_string","light_string",False,False,False,False,0,"forest","a river blocks your path","",[],[],[],[],[])
river_c = scene_type(3,-2,0,"river","temp_string","light_string",False,False,False,False,0,"forest","a river blocks your path","",[],[],[],[],[])
river_d = scene_type(4,-2,0,"river","temp_string","light_string",False,False,False,False,0,"forest","a river blocks your path","",[],[],[],[],[])
river_e = scene_type(6,-2,0,"river","temp_string","light_string",False,False,False,False,0,"forest","a river blocks your path","",[],[],[],[],[])
river_f = scene_type(7,-2,0,"river","temp_string","light_string",False,False,False,False,0,"forest","a river blocks your path","",[],[],[],[],[])
river_g = scene_type(8,-2,0,"river","temp_string","light_string",False,False,False,False,0,"forest","a river blocks your path","",[],[],[],[],[])
lake_a = scene_type(0,-2,0,"lake","temp_string","light_string",False,False,False,False,0,"forest","a deep lake blocks your path","",[],[],[],[],[])
lake_b = scene_type(0,-3,0,"lake","temp_string","light_string",False,False,False,False,0,"forest","a deep lake blocks your path","",[],[],[],[],[])
lake_c = scene_type(-1,-2,0,"lake","temp_string","light_string",False,False,False,False,0,"forest","a deep lake blocks your path","",[],[],[],[],[])
lake_d = scene_type(-1,-3,0,"lake","temp_string","light_string",False,False,False,False,0,"forest","a deep lake blocks your path","",[],[],[],[],[])

ocean = scene_type(999,999,999,"the ocean","temp_string","light_string",False,False,False,False,0,"forest","the ocean blocks your escape","",[],[],[],[],[])

solid_cave_wall = scene_type(998,998,998,"a solid cave wall","temp_string","light_string",False,False,False,False,0,"forest","a sheer wall of rock blocks your path","",[],[],[],[],[])
solid_cave_ground = scene_type(997,997,997,"a solid cave floor","temp_string","light_string",False,False,False,False,0,"forest","a floor of rock blocks your path","",[],[],[],[],[])
ground = scene_type(996,996,996,"the ground","temp_string","light_string",False,False,False,False,0,"forest","the ground blocks your path","",[],[],[],[],[])
sky = scene_type(995,995,995,"the sky","temp_string","light_string",False,False,False,False,0,"forest","you are unable to move up","",[],[],[],[],[])
solid_dungeon_wall = scene_type(994,994,994,"a solid dungeon wall","temp_string","light_string",False,False,False,False,0,"forest","a wall of stone brick blocks your path","",[],[],[],[],[])
solid_dungeon_ground = scene_type(993,993,993,"a solid dungeon floor","temp_string","light_string",False,False,False,False,0,"forest","a floor of stone brick blocks your path","",[],[],[],[],[])
...
#arrow spells
fire_arrow = spell("fire arrow",False,80,"fire",100,0,"light fire damage")
...
#status 20 spells BUFF MAGIC
focus = spell("focus",True,5,"fire",55,20,"buffs your magic stat")
...
goblin = enemy_stats(Fore.YELLOW + "goblin" + Style.RESET_ALL,2,5,100,100,1,5,2,100,"earth","fire",[],[],[],[],[],[],0)
hobgoblin = enemy_stats(Fore.YELLOW + "hobgoblin" + Style.RESET_ALL,3,12,500,500,1,4,5,300,"earth","fire",[],[],[],[],[],[],0)
bandit = enemy_stats(Fore.YELLOW + "bandit" + Style.RESET_ALL,5,10,200,200,1,5,2,100,"fire","earth",[],[],[],[],[],[],0)

legion_soldier = enemy_stats(Fore.YELLOW + "legion soldier" + Style.RESET_ALL,28,500,1000,1000,10,14,20,1000,"air","earth",[],[],[],[],[],[],0)
legion_spearman = enemy_stats(Fore.YELLOW + "legion spearman" + Style.RESET_ALL,25,500,1050,1050,10,16,10,1050,"air","earth",[],[],[],[],[],[],0)
legion_archer = enemy_stats(Fore.YELLOW + "legion archer" + Style.RESET_ALL,23,500,870,870,10,11,22,654,"air","earth",[],[],[],[],[],[],0)
legion_battle_mage = enemy_stats(Fore.YELLOW + "legion battle mage" + Style.RESET_ALL,29,500,1240,1240,45,5,6,2245,"air","earth",[],[],[],[],[],[],0)

rock_golem = enemy_stats(Fore.YELLOW + "rock golem" + Style.RESET_ALL,62,800,10230,10230,0,55,18,20230,"earth","water",[],[],[],[],[],[],0)
mushroom_man = enemy_stats(Fore.YELLOW + "mushroom man" + Style.RESET_ALL,67,800,10230,10230,0,50,20,10230,"earth","fire",[],[],[],[],[],[],0)

bird_warrior = enemy_stats(Fore.YELLOW + "bird warrior" + Style.RESET_ALL,191,100000,240807,240807,100,300,220,100,"air","water",[],[],[],[],[],[],0)#leg

fire_elemental = enemy_stats(Fore.YELLOW + "fire elemental" + Style.RESET_ALL,8,200,320,320,8,5,2,100,"fire","water",[],[],[],[],[],[],0)
water_elemental = enemy_stats(Fore.YELLOW + "water elemental" + Style.RESET_ALL,8,200,380,380,8,5,2,100,"water","earth",[],[],[],[],[],[],0)
earth_elemental = enemy_stats(Fore.YELLOW + "earth elemental" + Style.RESET_ALL,8,100,320,320,3,5,2,100,"earth","water",[],[],[],[],[],[],0)
air_elemental = enemy_stats(Fore.YELLOW + "air elemental" + Style.RESET_ALL,8,100,300,300,3,5,2,100,"air","earth",[],[],[],[],[],[],0)

giant_snail = enemy_stats(Fore.YELLOW + "giant snail" + Style.RESET_ALL,14,10,930,930,0,12,2,930,"earth","earth",[],[],[],[],[],[],0)
giant_spider = enemy_stats(Fore.YELLOW + "giant spider" + Style.RESET_ALL,33,64,2300,2300,0,50,2,2300,"earth","fire",[],[],[],[],[],[],0)
giant_moth = enemy_stats(Fore.YELLOW + "giant moth" + Style.RESET_ALL,18,5,1340,1340,0,10,20,100,"earth","air",[],[],[],[],[],[],0)

big_slug = enemy_stats(Fore.YELLOW + "big slug" + Style.RESET_ALL,1,500,10300,10300,0,0,0,0,"slime","salt",[],[],[],[],[],[],0)#legendary

skeleton_mage = enemy_stats(Fore.YELLOW + "skeleton mage" + Style.RESET_ALL,101,4202,60007,6007,53,30,22,100,"undead","holy",[],[],[],[],[],[],0)
skeleton_warrior = enemy_stats(Fore.YELLOW + "skeleton warrior" + Style.RESET_ALL,101,50922,9207,9207,0,63,42,100,"undead","holy",[],[],[],[],[],[],0)
...
fortress_gate.scene_inventory.append(ground_certificate_of_passage.name)
...
wizard_inventory.append(fireball)
wizard_inventory.append(hydro_barrage)
wizard_inventory.append(holy_surge)

wizard_inventory.append(hydroblast)
wizard_inventory.append(fireblast)
wizard_inventory.append(windblast)
wizard_inventory.append(earthblast)

wizard_inventory.append(super_heal)
wizard_inventory.append(prayer)

wizard_inventory.append(snare)
wizard_inventory.append(poison)
wizard_inventory.append(burn)
...
bird_store_inventory.append(torch)
bird_store_inventory.append(rope)
bird_store_inventory.append(tent)
bird_store_inventory.append(hp_potion)
bird_store_inventory.append(super_hp_potion)
bird_store_inventory.append(cup_of_tea)
bird_store_inventory.append(tea_bag)

bird_store_armor.append(leather_armor)
bird_store_armor.append(hard_leather_armor)
bird_store_armor.append(iron_chain_mail)
        ...
        for spell in enemy_stats.spellbook:
            ...
            if spellchance == 1:
                if spell.effect == 0:
                    ...
                    print(Fore.RED + Style.BRIGHT + str(enemy_spell_damage))
                    sleep(sleep_time)
                    if player1.hp <= 0:
                        print("\nYOU ARE DEAD \n")
                        in_fight = False
                ...
                if spell.effect == 1:
                    ...
                    print(Fore.GREEN + Style.BRIGHT + str(enemy_healing))
                    sleep(sleep_time)
                    break
                if spell.effect == 2:
                    print("\n" + enemy_stats.name + " casts :")
...
def func_enemy_melee(enemy_stats):
    for player_stats in players:
        ...
        print("\n" + enemy_stats.name + " hit you for")
        print(Fore.RED + Style.BRIGHT + str(enemy_damage))
        sleep(sleep_time)
...
def func_check_level():
    ...
    for player_stats in players:
        ...
        player_stats.maxhp = (player_stats.level * 100) + (player_stats.defence * 25) + (player_stats.maxhp_bonus * 25) + (player_stats.strength * 10) + (player_stats.attack * 10) + (player_stats.magic * 10)
...
def location_desc():
    ...
    for scene_type in location:
        ...
        sleep(sleep_time_fast)
        print(Fore.CYAN + "\"" + scene_type.flavour + "\" \n" + Style.RESET_ALL)
        sleep(sleep_time_fast)
...
####################################################
        ...
        for player1 in players:
            ...
            if len(equiped_helmet) != 0:
                for helmet in equiped_helmet:
                    ...
                    print("name: " + helmet.name + " || attribute: " + helmet.attribute + " || type: " + helmet.type)
                    print("magic: ", helmet.magic_bonus," || strength: ", helmet.strength_bonus," || attack: ", helmet.attack_bonus)
                    print("defence: ", helmet.defence_bonus," || hp bonus: ", helmet.maxhp_bonus)
            ...
            if len(equiped_armor) != 0:
                for armor in equiped_armor:
                    ...
                    print("name: " + armor.name + " || attribute: " + armor.attribute + " || type: " + armor.type)
                    print("magic: ", armor.magic_bonus," || strength: ", armor.strength_bonus," || attack: ", armor.attack_bonus)
                    print("defence: ", armor.defence_bonus," || hp bonus: ", armor.maxhp_bonus)
        ...
        dropped_item = input("Which item do you want to drop? \n")
        has_item = False
        for item in inventory:
                    ...
                    if scene_type == dismurth_tower:
                            ...
                            if response == "yes":
                                ...
                                for spell in wizard_inventory:
                                    print(spell.name + " ----- ", spell.damage, " gp. ")
