...
lakeside = scene_type(0,-1,0,"lake side","temperate","sunny",True,True,True,"","a small beach on the shore of the lake",[],[],[])
...
tunnel_a = scene_type(2,4,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "there is light coming from above...",[],[],[])
tunnel_b = scene_type(3,4,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, i wonder why it's here",[],[],[])
tunnel_c = scene_type(4,4,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "there are carvings on the wall, they depict goblins fighting some kind of demonic creature.",[],[],[])
tunnel_d = scene_type(5,4,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "there are carvings of goblins and humans massed in a large army, 2",[],[],[])

tunnel_e = scene_type(5,3,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, i wonder why it's here",[],[],[])
tunnel_f = scene_type(5,2,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, carvings depict a three headed dragon fighting a large demon",[],[],[])
tunnel_g = scene_type(5,1,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, skeletons of ancient warriors line the walls here",[],[],[])
tunnel_h = scene_type(5,0,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel",[],[],[])
tunnel_i = scene_type(5,-1,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, it smells of decay",[],[],[])
tunnel_j = scene_type(5,-2,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, the air is still",[],[],[])
tunnel_k = scene_type(5,-3,-3,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, it's carved from solid rock",[],[],[])
...
birdshirt = armor(301,"bird t shirt",100,"light",99,"air",10,0,0,0,110)
leather_armor = armor(302,"leather armor",10,"light",1,"water",0,0,0,0,10)
hard_leather_armor = armor(303,"hard leather armor",10,"light",10,"water",0,0,0,0,50)
iron_chain_mail = armor(304,"iron chain mail",40,"heavy",12,"earth",0,0,0,0,50)
iron_plate_armor = armor(305,"iron plate armor",100,"heavy",15,"earth",0,0,0,0,500)
steel_chain_mail = armor(306,"steel chain mail",400,"heavy",14,"earth",0,0,0,0,100)
steel_plate_armor = armor(307,"steel plate armor",1000,"heavy",22,"earth",0,0,0,0,1000)
rags = armor(308,"rags",1,"light",1,"fire",0,1,1,1,1)
mage_robes = armor(309,"mage robes",1000,"mage",20,"air",50,0,0,20,1000)
necro_robes = armor(309,"necromancer robes",1000,"mage",44,"air",50,0,0,50,2000)
