...
class enemy_stats:
    def __init__(self, is_npc, name, level, xp, hp, maxhp, mp, maxmp, magic, strength, attack, defence, gp, attribute, weakness, spellbook, drop_table_items_always, drop_table_weapons_always, drop_table_armor_always, drop_table_helmets_always, drop_table_shields_always, status_effect, sprite_variable):
        ...
        self.cast_sprite = spr_cast_fire1
...
wolf = enemy_stats(False,"mangy wolf",2,4,150,150,100,100,1,17,16,8,8,"earth","water",[],[meat,bones],[],[],[],[],0,"wolf")
ice_wolf = enemy_stats(False,"ice wolf",2,4,200,200,100,100,1,17,16,8,100,"ice","fire",[],[meat,bones],[wooden_staff],[],[],[],0,"ice_wolf")

goblin = enemy_stats(False,"goblin",2,5,80,80,100,100,11,12,10,10,11,"earth","fire",[],[bones],[wooden_staff,tall_staff,staff_of_earth,iron_axe],[],[],[],0,"goblin")
hobgoblin = enemy_stats(False,"hobgoblin",4,12,100,100,100,100,8,10,5,10,12,"earth","fire",[],[bones],[wooden_staff,iron_knife,staff_of_earth,short_dagger],[],[],[],0,"goblin2")
hobgoblin_berzerker = enemy_stats(False,"hobgoblin berzerker",9,22,1000,1000,100,100,1,12,10,30,300,"earth","fire",[],[bones],[wooden_staff,tall_staff,staff_of_earth,iron_dagger],[],[],[],0,"goblin2")

bandit = enemy_stats(False,"bandit",5,10,2000,2000,1000,1000,1,12,6,18,100,"fire","earth",[],[bones],[iron_sword,iron_dagger],[],[],[],0,"")
bandit_warlock = enemy_stats(False,"bandit warlock",8,28,2000,2000,5000,5000,18,5,2,18,70,"fire","earth",[],[bones],[tall_staff],[],[],[],0,"")
bandit_henchman = enemy_stats(False,"bandit henchman",12,50,2000,2000,2200,2200,10,12,4,18,230,"fire","earth",[],[bones],[steel_sword,steel_axe],[],[],[],0,"")

legion_soldier = enemy_stats(False,"legion soldier",28,500,10000,10000,100,100,10,14,20,100,1000,"air","earth",[],[bones],[],[],[],[],0,"")
legion_spearman = enemy_stats(False,"legion spearman",25,500,10500,10500,100,100,10,16,10,100,1050,"air","earth",[],[bones],[],[],[],[],0,"")
legion_archer = enemy_stats(False,"legion archer",23,500,8700,8700,100,100,10,11,22,100,654,"air","earth",[],[bones],[],[],[],[],0,"")
legion_battle_mage = enemy_stats(False,"legion battle mage",29,500,12400,12400,1000,1000,45,5,6,100,2245,"air","earth",[],[bones],[],[],[],[],0,"")

elf_warrior = enemy_stats(False,"elf warrior",32,100,15000,15000,2000,2000,10,20,22,100,100,"earth","fire",[],[bones],[],[],[],[],0,"")
...
elf_ranger = enemy_stats(False,"elf ranger",50,500,18800,18800,1000,1000,50,52,63,100,3245,"earth","fire",[],[bones],[],[],[],[],0,"")
elf_necromancer = enemy_stats(False,"elf necromancer",48,500,16200,16200,1000,1000,60,22,33,100,3245,"earth","holy",[],[bones],[],[],[],[],0,"")

ice_golem = enemy_stats(False,"ice golem",64,800,11230,11230,100,100,0,52,22,500,2230,"ice","fire",[],[],[],[],[],[],0,"")
rock_golem = enemy_stats(False,"rock golem",62,800,10520,10520,100,100,0,55,18,500,20230,"earth","water",[],[],[],[],[],[],0,"")
mushroom_man = enemy_stats(False,"mushroom man",67,800,10230,10230,100,100,0,50,20,500,10230,"earth","fire",[],[],[],[],[],[],0,"")
magical_mushroom_man = enemy_stats(False,"magical mushroom man",62,800,10230,10230,100,100,45,20,20,538,10230,"earth","fire",[],[],[],[],[],[],0,"")

bird_warrior = enemy_stats(False,"bird warrior",191,100000,2408070,2408070,1000000,1000000,100,300,220,1000,1000,"air","water",[],[bones],[],[],[],[],0,"")#leg

fire_elemental = enemy_stats(False,"fire elemental",8,200,3200,3200,1000,1000,18,5,2,1,100,"fire","water",[],[],[],[],[],[],0,"fire_ele")
water_elemental = enemy_stats(False,"water elemental",8,200,3800,3800,1000,1000,18,5,2,1,100,"water","earth",[],[],[],[],[],[],0,"water_ele")
earth_elemental = enemy_stats(False,"earth elemental",8,100,3200,3200,1000,1000,13,5,2,1,100,"earth","water",[],[],[],[],[],[],0,"earth_ele")
air_elemental = enemy_stats(False,"air elemental",8,100,3000,3000,1000,1000,13,5,2,1,100,"air","earth",[],[],[],[],[],[],0,"air_ele")

giant_snail = enemy_stats(False,"giant snail",14,10,9300,9300,100,100,0,12,2,100,930,"earth","earth",[],[],[],[],[],[],0,"")
giant_spider = enemy_stats(False,"giant spider",33,64,23000,23000,100,100,0,50,2,70,2300,"earth","fire",[],[],[],[],[],[],0,"")
giant_moth = enemy_stats(False,"giant moth",18,5,13400,13400,100,100,0,10,20,40,100,"earth","air",[],[],[],[],[],[],0,"")

big_slug = enemy_stats(False,"big slug",100,500,1035000,1035000,100,100,0,0,0,1,0,"slime","salt",[],[],[],[],[],[],0,"")#legendary

skeleton_mage = enemy_stats(False,"skeleton mage",101,4202,60070,60070,100,100,53,30,22,600,100,"undead","holy",[],[bones],[],[],[],[],0,"")
skeleton_warrior = enemy_stats(False,"skeleton warrior",101,50922,92070,92070,100,100,0,63,42,700,100,"undead","holy",[],[bones],[],[],[],[],0,"")
