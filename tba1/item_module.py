...
rotten_food = item(100,"rotten food",1,True,True,100,"")
all_game_items.append(rotten_food)

#edible healing items
pear = item(101,"pear",20,True,False,300,"")
all_game_items.append(pear)
cabbage = item(101,"cabbage",2,True,False,10,"")
all_game_items.append(cabbage)
turnip = item(101,"turnip",5,True,False,50,"")
all_game_items.append(turnip)
banana = item(101,"banana",15,True,False,150,"")
all_game_items.append(banana)
pineapple = item(101,"pineapple",18,True,False,300,"")
all_game_items.append(pineapple)
mushroom = item(101,"mushroom",2,True,True,500,"")
all_game_items.append(mushroom)
magic_mushroom = item(101,"magic mushroom",50,True,False,1000,"")
all_game_items.append(magic_mushroom)

mushroom_tea = item(108,"cup of mushroom tea",20,True,False,800,"")
all_game_items.append(mushroom_tea)
mushroom_brew = item(108,"mushroom brew",28,True,False,8250,"")
...
cup_of_tea = item(108,"cup of tea",5,True,False,800,"")
...
super_hp_potion = item(111,"super hp potion",200,True,False,10000,"")
all_game_items.append(super_hp_potion)

#fish
fish_salmon = item(111,"salmon",2000,True,False,10000,"")
all_game_items.append(fish_salmon)
fish_trout = item(111,"trout",1200,True,False,2200,"")
all_game_items.append(fish_trout)
fish_herring = item(111,"herring",200,True,False,1000,"")
all_game_items.append(fish_herring)
fish_baron_maryan = item(111,"baron maryan",50000,True,False,150000,"")
all_game_items.append(fish_baron_maryan)

#??? items:
fire_orb = item(106,"fire orb",1000,False,False,0,"")
all_game_items.append(fire_orb)
water_orb = item(106,"water orb",900,False,False,0,"")
all_game_items.append(water_orb)
earth_orb = item(106,"earth orb",800,False,False,0,"")
all_game_items.append(earth_orb)
air_orb = item(106,"air orb",700,False,False,0,"")
