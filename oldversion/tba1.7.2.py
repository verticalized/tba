...
moors_a = scene_type(6,1,0,"the moors","humid","sunny",False,False,True,False,0,"forest","","damp grass and low stone walls form paddocks around you",[],[],[],[],[])
moors_b = scene_type(7,1,0,"the moors","humid","sunny",False,False,True,False,0,"forest","","",[],[],[],[],[])
...
south_road_a = scene_type(5,-1,0,"the south road","temperate","cloudy",True,False,True,False,0,"forest","", "this road leads from the crossroads to the south ",[],[],[],[],[])
dismurth_bridge = scene_type(5,-2,0,"the Dismurth bridge","temperate","cloudy",True,False,True,False,0,"forest","", "the water looks nice from here",[],[],[],[],[])
south_road_b = scene_type(5,-3,0,"the south road","temperate","cloudy",True,False,True,False,0,"forest","", "this road continues from the crossroads to the south",[],[],[],[],[])
...
bird_store_inventory.append(rent)
...
def func_enemy_dead(enemy_stats):
            ...
            if loot_spawn_chance_helmet == 1:
                if len(enemy_stats.drop_table_helmets) != 0:
                    for helmet.name in enemy_stats.drop_table_helmets:
            ...
            if loot_spawn_chance_shield == 1:
                if len(enemy_stats.drop_table_shields) != 0:
                    for shield.name in enemy_stats.drop_table_shields:
            ...
            if scene_type.npc == True:
                ...
                for scene_type in location:
                    if scene_type == dismurth_tower:
                            ...
                            response = raw_input("I am the town mage, would you like to learn any spells?\n")
                            if response == "yes":
                                print("gold: ", player1.gp)
                                print("wizard's spellbook:\n")
                                for spell in wizard_inventory:
                                    print(spell.name + " ----- ", spell.damage, " gp. ")
                                bought_item = raw_input("please, choose a spell to learn\n")
                                has_item = False
                                for spell in wizard_inventory:
