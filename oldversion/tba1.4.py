...
lakeside = scene_type(0,-1,0,"lake side","temperate","sunny",True,False,True,"","a small beach on the shore of the lake",[],[],[])

#large tree cave
large_tree = scene_type(1,0,0,"a large tree","temperate","shady",True,False,True,"","a very, very large oak tree",[],[],[])
large_tree_tunnel_a = scene_type(1,0,-1,"a tunnel","temperate","shady",True,False,True,"","there are tree roots supporting the tunnel",[],[],[])
large_tree_tunnel_b = scene_type(1,0,-2,"a tunnel ","temperate","shady",True,False,True,"","the tunnel goes down quite far",[],[],[])
large_tree_cave_a = scene_type(1,0,-3,"oak tree cave","temperate","shady",True,False,True,"","a cave below the large oak tree",[],[],[])
large_tree_cave_b = scene_type(0,0,-3,"oak tree cave","temperate","shady",True,False,True,"","a cave below the large oak tree",[],[],[])
large_tree_cave_c = scene_type(0,-1,-3,"oak tree cave","temperate","shady",True,False,True,"","a cave below the large oak tree",[],[],[])
large_tree_cave_d = scene_type(0,-2,-3,"oak tree cave","temperate","shady",True,False,True,"","a cave below the large oak tree",[],[],[])
large_tree_cave_e = scene_type(0,-3,-3,"oak tree cave","temperate","shady",True,False,True,"","a cave below the large oak tree",[],[],[])
large_tree_cave_door = scene_type(0,-4,-3,"oak doorway","temperate","shady",True,False,False,"this door is locked, you need a key.","you unlock the door with the oak key..",[],[],[])
large_tree_cave_f = scene_type(0,-5,-3,"oak tree cave","temperate","shady",True,False,True,"","a cave below the large oak tree",[],[],[])
...
moors_a = scene_type(6,1,0,"the moors","humid","sunny",False,False,True,"","damp grass and low stone walls form paddocks around you",[],[],[])
moors_b = scene_type(7,1,0,"the moors","humid","sunny",False,False,True,"","",[],[],[])
...
swamp = scene_type(17,17,0,"swamp","temperate","cloudy",False,False,True,"", "some particularly generic fields",[],[],[])
...
cave_b = scene_type(5,-4,-2,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further...",[],[],[])
cave_c = scene_type(5,-4,-3,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further...",[],[],[])
cave_d = scene_type(5,-4,-4,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further...",[],[],[])
cave_e = scene_type(5,-4,-5,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further...",[],[],[])
cave_f = scene_type(5,-4,-6,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further...",[],[],[])
cave_g = scene_type(5,-4,-7,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further...",[],[],[])
cave_h = scene_type(5,-4,-8,"a cave","temperate","cloudy",True,False,True,"", "there is a cavern below...",[],[],[])

cavern_a = scene_type(5,-4,-9,"the center of a cavern","temperate","cloudy",True,False,True,"", "there is light coming from above...",[],[],[])
cavern_b = scene_type(5,-3,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
cavern_c = scene_type(5,-5,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
cavern_d = scene_type(6,-3,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
cavern_e = scene_type(4,-3,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
cavern_f = scene_type(4,-4,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
cavern_g = scene_type(4,-5,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
cavern_h = scene_type(6,-4,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
cavern_i = scene_type(6,-5,-9,"a cavern","temperate","cloudy",False,False,True,"", "",[],[],[])
...
north_cave_a = scene_type(2,4,-1,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further, there is light coming from above...",[],[],[])
north_cave_b = scene_type(2,4,-2,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further, there is light coming from above...",[],[],[])
north_cave_c = scene_type(2,4,-3,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further, there is a faint light coming from above...",[],[],[])
north_cave_d = scene_type(2,4,-4,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further, there is a faint light coming from above...",[],[],[])
north_cave_e = scene_type(2,4,-5,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further, there is a faint light coming from above...",[],[],[])
north_cave_f = scene_type(2,4,-6,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further, there is a faint light coming from above...",[],[],[])
north_cave_g = scene_type(2,4,-7,"a cave","temperate","cloudy",True,False,True,"", "this cave goes down further, there is a faint light coming from above...",[],[],[])
north_cave_h = scene_type(2,4,-8,"a cave","temperate","cloudy",True,False,True,"", "there is a tunnnel below, there is a very faint light coming from above...",[],[],[])

tunnel_a = scene_type(2,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "there is a very faint light coming from above...",[],[],[])
tunnel_b = scene_type(3,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, i wonder why it's here",[],[],[])
tunnel_c = scene_type(4,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "there are carvings on the wall, they depict goblins fighting some kind of demonic creature.",[],[],[])
tunnel_d = scene_type(5,4,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "there are carvings of goblins and humans massed in a large army, 2",[],[],[])

tunnel_e = scene_type(5,3,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, i wonder why it's here",[],[],[])
tunnel_f = scene_type(5,2,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, carvings depict a three headed dragon fighting a large demon",[],[],[])
tunnel_g = scene_type(5,1,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, skeletons of ancient warriors line the walls here",[],[],[])
tunnel_h = scene_type(5,0,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel",[],[],[])
tunnel_i = scene_type(5,-1,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, it smells of decay",[],[],[])
tunnel_j = scene_type(5,-2,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, the air is still",[],[],[])
tunnel_k = scene_type(5,-3,-9,"an underground tunnel","temperate","cloudy",False,False,True,"", "this is an ancient tunnel, it's carved from solid rock",[],[],[])
...
cliffs_d = scene_type(-1,-1,0,"cliffs","temp_string","light_string",False,False,False,"cliffs block your path","",[],[],[])
...
solid_dungeon_wall = scene_type(994,994,994,"a solid dungeon wall","temp_string","light_string",False,False,False,"a wall of stone brick blocks your path","",[],[],[])
solid_dungeon_ground = scene_type(993,993,993,"a solid dungeon floor","temp_string","light_string",False,False,False,"a floor of stone brick blocks your path","",[],[],[])
...
iron_axe = weapon(205,"iron axe",8,"sword",5,"earth",0,10,10,10,10)
steel_axe = weapon(206,"steel axe",80,"sword",10,"earth",0,20,20,20,20)
...
class enemy_stats:
    def __init__(self, name, level, xp, hp, maxhp, magic, strength, attack, gp, attribute, weakness, spellbook, drop_table_items, drop_table_weapons, drop_table_armor, status_effect):
        self.name = name
        self.level = level
        self.xp = xp
        self.hp = hp
...
bird_warrior = enemy_stats("bird warrior",191,100000,240807,240807,100,300,220,100,"air","water",[],[],[],[],0)
...
def func_check_stat_bonus():
    for player_stats in players:
        for weapon in equiped_weapon:
            for armor in equiped_armor:
                player_stats.magic_bonus = weapon.magic_bonus + armor.magic_bonus
                player_stats.strength_bonus = weapon.strength_bonus + armor.strength_bonus
                player_stats.attack_bonus = weapon.attack_bonus + armor.attack_bonus
                player_stats.defence_bonus = weapon.defence_bonus + armor.defence_bonus
                player_stats.maxhp_bonus = weapon.maxhp_bonus + armor.maxhp_bonus
